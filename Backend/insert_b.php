...
// print_r($_GET);
// echo "</pre>";
$sr="SELECT * FROM customer_details_m";
...
if($rr)
{
  ...
  {
 // $string=$data['Number_Plate'];
if($data['Number_Plate'] == $Number_Plate){//micro-1,micro-3 r jnne works print howar kotha kintu hocche na
  print("Works");
}
...
$q="INSERT INTO customer_details_m(name,email,contactno,pickup_address,pickup_date_time,location,Number_Plate,price,reason)VALUES('$name','$email','$contactno','$pickup_address','$pickup_date_time','$location','$Number_Plate','$price','$reason')";
