...
$Price=$_GET['Price'];
$sr="SELECT * FROM customer_details_m where Number_Plate='$Number_Plate'";
...
$q="INSERT INTO customer_details_m(name,email,contactno,pickup_address,pickup_date,pickup_time,location,Number_Plate,price,reason,days)VALUES('$name','$email','$contactno','$pickup_address','$pickup_date','$pickup_time','$location','$Number_Plate','$price','$reason','$days')";
