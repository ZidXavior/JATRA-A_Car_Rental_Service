...
$q="INSERT INTO customer_details_t(name,email,contactno,pickup_address,pickup_date_time,price,reason,location,Number_Plate)VALUES('$name','$email','$contactno','$pickup_address','$pickup_date_time','$price','$reason','$location','$Number_Plate')";
