...
<table>
<tr><th>name</th><th>email</th><th>contactno</th><th>pickup_adress</th><th>pickup_date_time</th><th>price</th><th>reason</th><th>location</th><th>numberplate</th></tr>
<?php
$hostname='localhost';
$username='root';
$password='';
...
while($data=mysqli_fetch_assoc($r)){
    ...
    echo"<tr><td>$name</td><td>$email</td><td>$contactno</td><td>$pickup_address</td><td>$pickup_date_time</td><td>$Price</td><td>$reason</td><td>$location</td><td>$Number_Plate</td></tr>";
