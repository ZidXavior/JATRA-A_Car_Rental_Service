...
$q="INSERT INTO customer_details_b(name,email,contactno,pickup_address,pickup_date,location,Number_plat,price,reason,pickup_time,days)VALUES('$name','$email','$contactno','$pickup_address','$pickup_date','$location','$Number_plat','$price','$reason','$pickup_time','$days')";
