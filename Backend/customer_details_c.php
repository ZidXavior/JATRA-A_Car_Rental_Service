...
if($q)
{
    while($data=mysqli_fetch_assoc($q)){
        ...
        $reason=$data['reason'];
        $days=$data['days'];
        echo"<tr><td>$name</td><td>$email</td><td>$contactno</td><td>$pickup_address</td><td>$Pickup_time</td><td>$price</td><td>$Number_plate</td><td>$location</td><td>$reason</td><td>$days</td><td><a href='customer_c_d.php?email=$data[email]'>delete</a></td></tr>";
