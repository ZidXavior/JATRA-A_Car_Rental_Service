...
if($rr)
{
  if($data=mysqli_fetch_assoc($rr))
  {
if(data['Number_PLate']==$Number_PLate)
echo"error";
echo"error";
echo"error";
echo"error";
...
$q="INSERT INTO customer_details_c(name,email,contactno,pickup_address,pickup_date_time,location,Number_PLate,price,reason)VALUES('$name','$email','$contactno','$pickup_address','$pickup_date_time','$location','$Number_PLate','$price','$reason')";
